<div class="grid grid-cols-3 gap-3">
    ...
    <div class="col-span-2">
        <section class="task-form" x-data="{ taskid: @entangle('taskId').defer }">

            <div wire:loading.grid wire:target="edit, resetFormFields, save" class="h-96 max-h-screen place-items-center">
                <span class="spinner"></span>
            </div>
            
            <div wire:loading.remove wire:target="edit, resetFormFields, save" class="w-full max-w-7xl mx-auto sm:p-6 lg:p-8">
